...
def run_simulation(args):
        ...
        for tt in range(repeat_time):
            ...
            pulse_sequence = [
                ...
                },
                {
                    ...
                    'freq': 0, # unit in GHz; Z pulse does not use it
                    'phase': 0, # unit in rad; Z pulse does not use it
                    'amplitude': 5.152e-3,#-3.5e-3, # bisa_amp, # XY: Rabi freq; Z: biased frequency
                    'q_index': [0,1]
                },
                {
                ...
                { # Base line J23
                    ...
                    't_plateau':tau_d, #simulation_option['simulation_time'], # unit in ns
                    'freq': 0, # unit in GHz; Z pulse does not use it
                    'phase': 0, # unit in rad; Z pulse does not use it
    ...
    data = [ramsy_pop, tau_list,1,2, [half_pi_gt, repeat_time]]
...
def parse_arguments():
    ...
    parser.add_argument('--trail', type=int, default=-1,
                        help='')
    parser.add_argument('--noise', type=float, default=0.069e-3,
                        help='')
    parser.add_argument('--tau_list', nargs=3, type=int, default=[0, 100, 500],
                        help='')
    parser.add_argument('--ep_list', nargs=3, type=int, default=[10, 10, 1],
                        help='')
    parser.add_argument('--type', type=str, default='J',
                        help='')
    parser.add_argument('--inistate', type=str, default='S',
                    help='ud, du, S, T0')
